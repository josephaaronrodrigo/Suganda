    ...
    <body>
        ...
        <div class="container">
            <div class="btn-group btn-group-justified">
                <a href="prodUpdate.php" class="btn btn-warning">Production</a>
                <a href="packingUpdate.php" class="btn btn-info active">Packing</a>
            </div>
            <br>
            <br>

            <!-- Start of Form -->
            <form class="form-horizontal" role="form" name="packUpdate" action="../control/production.php" method="POST">
                        ...
                        <script>
                            function getInput(str1) {
                                if (str1 == "") {
                                   ...
                                   var date = document.packUpdate.date.value;
                                    var p = document.packUpdate.plant_no.value;
                                    xmlhttp.open("GET", "Ajax/packingInputs.php?session=" + str1 + "&d=" + date + "&p=" + p, true);
                                    xmlhttp.send();
