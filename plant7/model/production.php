...
class Production {
    ...
    function updateProd($plant_no, $date, $session, $line_no, $style, $session_start, $output, $mos, $remarks) {
        $conn = new Connection();
        $sql = "INSERT INTO production_out VALUES('$plant_no','$date','$session','$line_no','$style','$session_start','$output','$mos','$remarks')";
        $result = $conn->query($sql);
        return $result;
    }
