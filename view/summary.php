...
<body class="menubar-hoverable header-fixed ">
    ...
    <div class="wrapper">
        <br><br><br>
        <h1 class="text-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Production Summary</h1>
                        ...
                        <tbody>
                            ...
                            while ($i < sizeof($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $obj->genStyleAllDet('order_qty', $result[$i]); ?></td>
                                    <td><?php echo $pty = $obj->genStyleAllDet('planned_qty', $result[$i]); ?></td>
                                    <td><?php echo $comp = $obj->getCompleted($result[$i]); ?></td>
                                    <td><?php echo $pty - $comp; ?></td>
