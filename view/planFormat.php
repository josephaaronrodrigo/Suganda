    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" role="form" name="planInput" action="../control/production.php" method="POST">
                            ...
                            <script>
                                function getStyle(str1) {
                                    ...
                                    if (str1 == "") {
                                        ...
                                        xmlhttp.open("GET", "Ajax/planInput.php?y=" + y + "&m=" + m+"&p="+p, true);
                                        xmlhttp.send();
                                    }
                                }
                            </script>
                        ...
                        <input type="hidden" name="switch" value="8">
                    </form>
                </div>
