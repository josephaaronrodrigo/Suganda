...
<div class="row">
        ...
        <div class="container-fluid">
            <div style="overflow-x:auto; width:250px;">
                <table class="table table-bordered table-condensed" style="text-align: center;">
                    <tr>
                        <th style="background-color: #5cb85c ; text-align: center;">Planned</th>
                    ...
                    <tr>
                        <td><?php echo $obj->plannedMOS($date, $plant_no); ?></td>
                        <?php
                        $m = 1;
            ...
            <div class="container-fluid">
                <div style="overflow-x:auto; width:<?php echo $width; ?>; height:auto">
                    <table class="table table-bordered table-condensed">
                        <tbody>
                            ...
                            <tr>
                                ...
                                while ($i <= $lines) {
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0; color: white; background-color: #337ab7; "><input readonly value="<?php echo $i; ?>" style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: #337ab7; font-size: 16px" type="text" class="form-control" name="line_no[]" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($i <= $lines) {
                                    ...
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0; background-color: #337ab7;"><input style="color: white; background-color: #337ab7;display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" readonly value="<?php echo $s; ?>"/></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                <th class="btn-info" style="text-align: center; background-color: #5bc0de;"><text style="font-size: 16px;"></text></th>
                                <?php
                                $i = 1;
                                while ($i <= $lines) {
                                    ?>                                
                                    <td colspan="2" style="margin: 0; padding: 0; background-color: #337ab7;"><input style="color: white; background-color: #337ab7;display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" readonly value="QTY"/></td>
                                    <td colspan="2" style="margin: 0; padding: 0; background-color: #337ab7;"><input style="color: white; background-color: #337ab7;display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" readonly value="INC"/></td>
                                    <td colspan="2" style="margin: 0; padding: 0; background-color: #337ab7;"><input style="color: white; background-color: #337ab7;display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" readonly value="DAY"/></td>
                                    <td colspan="2" style="margin: 0; padding: 0; background-color: #337ab7;"><input style="color: white; background-color: #337ab7;display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" readonly value="AVG"/></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                <th class="btn-info" style="text-align: center; background-color: #5bc0de;"><text style="font-size: 16px;">Planned</text></th>
                                <?php
                                $i = 1;
                                $planned_qty = array();
                                $psdate = array();
                                ...
                                $pdays = array();
                                while ($i <= $lines) {
                                    $planned = $obj->getUnitPrice($plant_no, $date, $style[$i]);
                                    $planned_a = mysql_fetch_array($planned);
                                    $planned_qty[$i] = $planned_a['planned_qty'];
                                    $psdate[$i] = $planned_a['start_date'];
                                    $pedate[$i] = $planned_a['end_date'];
                                    $unit_price[$i] = $planned_a['unit_price'];
                                    $pdays[$i] = $obj->countWorkingDays($plant_no, $psdate[$i], $pedate[$i]);
                                    if ($style[$i] != "") {
                                        $pInc = number_format(($planned_qty[$i] * $unit_price[$i]), 2, '.', ',');
                                        $pavg = number_format($planned_qty[$i] / $pdays[$i],2,'.',',');
                                    } else {
                                        $pInc = "";
                                        $pavg = "";
                                    }
                                    ?>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $planned_qty[$i]; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $pInc; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $pdays[$i]; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $pavg; ?>" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                <th class="btn-info" style="text-align: center; background-color: #5bc0de;"><text style="font-size: 16px;">Achieved</text></th>
                                <?php
                                $i = 1;
                                $actualprod = array();
                                $adays = array();
                                while ($i <= $lines) {
                                    $actualp = $obj->totActProd($plant_no, $style[$i], $psdate[$i], $pedate[$i], $date, $i);
                                    $actuala = mysql_fetch_array($actualp);
                                    $actualprod[$i] = $actuala['completed'];
                                    $adaysr = $obj->getRunningDay($style[$i], $plant_no, $i, $date);
                                    $adaysa = mysql_fetch_array($adaysr);
                                    $adays[$i] = $adaysa['dates'];
                                    if ($style[$i] != "") {
                                        $aInc = number_format(($actualprod[$i] * $unit_price[$i]), 2, '.', ',');
                                        $aavg = number_format($actualprod[$i] / $adays[$i],2,'.',',');
                                    } else {
                                        $aInc = "";
                                        $aavg = "";
                                    }
                                    ?>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $actualprod[$i]; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $aInc; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $adays[$i]; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $aavg; ?>" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                <th class="btn-info" style="text-align: center; background-color: #5bc0de;"><text style="font-size: 16px;">Balance</text></th>
                                <?php
                                $i = 1;

                                while ($i <= $lines) {
                                    if ($style[$i] != "") {
                                        $balQty = $planned_qty[$i] - $actualprod[$i];
                                        $balInc = number_format(($balQty * $unit_price[$i]), 2, '.', ',');
                                        $balDays = $pdays[$i] - $adays[$i];
                                        $bavg = number_format($balQty / $balDays,2,'.',',');
                                    } else {
                                        $balQty = "";
                                        $balInc = "";
                                        $balDays = "";
                                    ...
                                    ?>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $balQty; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $balInc; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $balDays; ?>" /></td>
                                    <td colspan="2" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $bavg; ?>" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $dayPlan[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $count; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                $planmo = $totS;
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $pfMO[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            while ($m <= $lines) {
                                ...
                                ?>
                                                                                <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $prday; ?>" /></td>
                                <?php
                                $m++;
                            }
                            ?>
                            ...
                            <tr>
                                ...
                                while ($m < 11) {
                                    ...
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $planned_hours; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: ash" readonly  type="text" class="form-control" value="<?php echo $pph; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: white" readonly  type="text" class="form-control" value="<?php echo $actMO[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: white" readonly  type="text" class="form-control" value="<?php echo $dayPlan[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: white" readonly  type="text" class="form-control" value="<?php echo $actualHours[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($m <= $lines) {
                                    ...
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: white" readonly  type="text" class="form-control" value="<?php echo $hplan[$m]; ?>" /></td>
                                    <?php
                                    $m++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($i <= $lines) {
                                    ...
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: white" readonly  type="text" class="form-control" value="<?php echo $rday; ?>" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                while ($i <= $lines) {
                                    ?>
                                    <td colspan="8" style="margin: 0; padding: 0;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center;" type="text" class="form-control" /></td>
                                    <?php
                                    $i++;
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                <td colspan="<?php echo ($lines * 8); ?>" style="text-align: center; width: 200px; background-color: #337ab7;"></td>
                            </tr>
                            <?php
                                ...
                                <tr>
                                    ...
                                    while ($i <= $lines) {
                                        ...
                                        <td style="margin: 0; padding: 0; background-color: <?php echo $color; ?>">
                                            ...
                                            ?>"/></td>
                                        <td style="margin: 0; padding: 0; background-color: <?php echo $color; ?>; "><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: <?php echo $color; ?>; font-weight: bold;" readonly type="text" class="form-control" name="output[]" value="<?php
                                            if (($array1['output'] != "") || ($j < ($start_session + $actualHours[$i])) && ($j >= $start_session)) {
                                                echo $hplancum[$i];
                                            }
                                            ?>"/></td>
                                        ...
                                        <td style="margin: 0; padding: 0;  background-color: <?php echo $color; ?>;"><input style="display: block; padding: 0; margin: 0; border: 0; width: 100%; text-align: center; background-color: <?php echo $color; ?>; font-weight: bold;" readonly type="text" class="form-control" name="output[]" value="<?php
                                            ...
                                            ?>
                                        <td style="margin: 0; padding: 0; color: white;  background-color: <?php echo $color; ?>"><input style="display: block; padding: 0; margin: 0; color: white; border: 0; width: 100%; text-align: center; background-color: <?php echo $color; ?>" readonly type="text" class="form-control" name="output[]" value="<?php
                                            if ($array1['output'] != "") {
                                                echo $diff;
                                            }
                                            ?>"/></td>

                                        <td style="margin: 0; padding: 0; color: black;  background-color: white;"><input style="display: block; padding: 0; margin: 0; color: black; border: 0; width: 100%; text-align: center; background-color: white" readonly type="text" class="form-control" name="output[]" value="<?php
                                            if ($array1['accepted'] != "") {
                                                echo $array1['accepted'];
                                            }
                                            ?>"/></td>

                                        <td style="margin: 0; padding: 0; color: black;  background-color: white;"><input style="display: block; padding: 0; margin: 0; color: black; border: 0; width: 100%; text-align: center; background-color: white;" readonly type="text" class="form-control" value="<?php
                                            if ($array1['rejected'] != "") {
                                                echo $array1['rejected'];
                                            }
                                            ?>"/></td>
                                        <td style="border-right-color: #428bca; border-right-width: 6px; margin: 0; padding: 0; color: black;  background-color: white;"><input style="display: block; padding: 0; margin: 0; color: black; border: 0; width: 100%; text-align: center; background-color: white;" readonly type="text" class="form-control" value="<?php
                                            if ($array1['rej_rep'] != "") {
                                                echo $array1['rej_rep'];
                                            }
                                            ?>"/></td>
    ...
    <?php
    if ($_SESSION['user_level'] != 'plant_man') {
        ?>
        <ul class="pagination pull-right">
            ...
            ?>><a href="#" onclick="getPlantData(7)">7</a></li>
            <li <?php
            if ($plant_no == 7) {
                echo 'class="disabled"';
            }
