...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-condensed">
        ...
        <tr>
            ...
            <td align="center" style="background-color: WHITE"><b>Plant 2</b></td>
...
<tr>
            ...
            <td rowspan="3"style="margin: 0; width: 10px; padding: 0; vertical-align: middle; text-align: center; background-color: white;"><div><span>Training Center</span></div></td>

            <td style="margin: 0; width: 60px; padding: 0; vertical-align: middle; text-align: center; background-color: white;">On Roll</td>
            <?php
            $i = 1;
            $rowtot = 0;
            while ($i < 8) {
                ...
                $rowtot += $count;
                ?>	
                <td style="margin: 0; width: 60px; padding: 0; vertical-align: middle; text-align: center; background-color: white;"><?php echo $count; ?></td>
                <?php
                $i++;
            }
            ?>
            <td style="margin: 0; width: 60px; padding: 0; vertical-align: middle; text-align: center; background-color: white;"><?php echo $rowtot; ?></td>


        </tr>
        <tr>

            <td style="margin: 0; padding: 0; background-color: white; vertical-align: middle; text-align: center; background-color: white;">Present</td>
            <?php
            $i = 1;
            $rowtot = 0;
            while ($i < 8) {
        ...
        <tr>
            ...
            <td style="margin: 0; padding: 0; background-color: white; vertical-align: middle; text-align: center; background-color: white;">Absent</td>
            <?php
            $i = 1;
            $rowtot = 0;
            while ($i < 8) {
        ...
        <!-- TOTAL -->
<tr>
     <td rowspan="1"style="margin: 0; width: 10px; padding: 0; vertical-align: middle; text-align: center; background-color: #c5c5c5;"><div><span>11</span></div></td>
            <td rowspan="1" style="margin: 0; word-wrap: break-word;  padding: 0; vertical-align: middle; text-align: center; background-color: #c5c5c5;"><div><span>Maternity Leave</span></div></td>
