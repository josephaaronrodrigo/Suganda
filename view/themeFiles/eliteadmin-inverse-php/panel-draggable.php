...
?>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <h4 class="page-title">Draggable Panel</h4>
            </div>
            <!-- /.page title -->
            <!-- .breadcrumb -->
            ...
            <li class="active">Draggable Panel</li>
            </ol>
            </div>
            <!-- /.breadcrumb -->
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="white-box">
                     <h3 class="box-title">Simple draggable panel</h3>  Extended bootstrap panels with several common and useful functions which does not come by default. For more options, go to the <a href="https://lobianijs.com/site/lobipanel#description" target="_blank">official plugin website.</a></div>
               </div>
            </div>
            <!-- /.row -->
            <!-- .row -->
