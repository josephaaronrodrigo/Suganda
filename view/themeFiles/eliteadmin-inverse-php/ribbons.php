...
<div class="row">
   <div class="col-md-12">
      <div class="white-box">
         <h3 class="box-title">Badge ribbons</h3>
         <p>Add class: <code>.ribbon-badge</code>.
         <div class="row m-b-10">
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
               <div class="ribbon-wrapper ribbon-overflow">
                   <div class="ribbon ribbon-badge ribbon-info">Ribbon</div>
                   <p class="ribbon-content">Duis mollis, est non commodo luctus, nisi erat porttitor ligula</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
               <div class="ribbon-wrapper-reverse ribbon-overflow">
                   <div class="ribbon ribbon-badge ribbon-right ribbon-info">Ribbon</div>
                   <p class="ribbon-content">Duis mollis, est non commodo luctus, nisi erat porttitor ligula</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
               <div class="ribbon-wrapper-bottom ribbon-overflow">
                   <div class="ribbon ribbon-badge ribbon-info ribbon-bottom">Ribbon</div>
                   <p class="ribbon-content">Duis mollis, est non commodo luctus, nisi erat porttitor ligula</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
               <div class="ribbon-wrapper-right-bottom ribbon-overflow">
                   <div class="ribbon ribbon-badge ribbon-info ribbon-right ribbon-bottom">Ribbon</div>
                   <p class="ribbon-content">Duis mollis, est non commodo luctus, nisi erat porttitor ligula</p>
               </div>
            </div>
         </div>
