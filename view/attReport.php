    ...
    <body>
        ...
        <div class="container">
                ...
                <script>
                            function getReport(str) {
                                if (str == "") {
                                    ...
                                    xmlhttp.open("GET", "Ajax/att.php?d=" +str, true);
                                    xmlhttp.send();
                                }
                            }
                        </script>
            ...
            <div class="btn-group btn-group-justified">
                <a href="attReport.php" class="btn btn-success focus">Currently On Roll</a>
                <a href="resReport.php" class="btn btn-danger">New, Interviewed and Resigned</a>
            </div>
            <br>
            <br>
            <br>
