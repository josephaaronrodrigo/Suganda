    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row col-sm-12 ">
                ...
                <div class="col-sm-3">
                    <a href="planCalculator.php">
                        <div class="tile purple">
                            <h3 class="title">Plan Calculator</h3>
                            <p><i class="glyphicon glyphicon-th-list pull-right" style="font-size:30px; color: white;"></i></p>
                        </div>
                    </a>
                </div>
		...
		<div class="col-sm-5">
                ...
                <div class="col-sm-3">
                    <a href="summary.php">
                        <div class="tile aqua">
                            <h3 class="title">Production Totals</h3>
                            <p><i class="glyphicon glyphicon-paperclip pull-right" style="font-size:30px; color: white;"></i></p>
                        </div></a>
                </div>
            ...
            <div class="row col-sm-12 ">
                <div class="col-sm-5">
                    <a href="lineUpdate.php">
                        <div class="tile red">
                            <h3 class="title">Update M/O Report</h3>
                            <p><i class="glyphicon glyphicon-th-list pull-right" style="font-size:30px; color: white;"></i></p>
                        </div>
                    </a>
                </div>
