...
<meta name="theme-color" content="#ffffff">
    ...
    <body>
        ...
        <div class="container">
                                <form class="form-horizontal" role="form" action="../control/production.php" method="POST">
                ...
                <script>
                            function getLineInp(str) {
                                if (str == "") {
                                    ...
                                    xmlhttp.open("GET", "Ajax/lineUpd.php", true);
                                    xmlhttp.send();
                                }
                            }
                        </script>
            ...
            <div class="btn-group btn-group-justified">
                <a href="" class="btn btn-success">Line Wise M/O Update</a>
