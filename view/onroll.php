    ...
    <body>
        ...
        <div class="container">
            <div class="btn-group btn-group-justified">
                <a href="onroll.php" class="btn btn-success active">On Roll</a>
                <a href="resigned.php" class="btn btn-primary focus">Interview, Newcomers and Resigned</a>
            </div>
            <br>
            <br>
                ...
                <script>
                            function getInput(str) {
                                if (str == "") {
                                    ...
                                    xmlhttp.open("GET", "Ajax/onRollInput.php", true);
                                    xmlhttp.send();
                                }
                            }
                        </script>
